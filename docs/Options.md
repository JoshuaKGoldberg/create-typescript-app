...
- `--bin` _(`string`)_: `package.json` bin value to include for npx-style running. (eg `"./bin/index.js"`) - this does not create any of folders or files; just references to them in the `package.json` bin property 
