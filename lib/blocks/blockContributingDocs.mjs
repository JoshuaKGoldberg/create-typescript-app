...
//#region src/blocks/blockContributingDocs.ts
const blockContributingDocs = base.createBlock({
	about: { name: "Contributing Docs" },
	produce({ options }) {
		return { files: { ".github": { "CONTRIBUTING.md": `# Contributing
...
Please do [report an issue on the issue tracker](https://github.com/${options.owner}/${options.repository}/issues/new/choose) if there's any bugfix, documentation improvement, or general enhancement you'd like to see in the repository!
...
` } } };
	...
	transition() {
		return { addons: [blockRemoveFiles({ files: ["CONTRIBUTING.md"] })] };
	}
});
//#endregion
export { blockContributingDocs };
