...
//#region src/blocks/blockContributorCovenant.ts
const blockContributorCovenant = base.createBlock({
	about: { name: "Contributor Covenant" },
	produce({ options }) {
		return {
			addons: [blockREADME({ badges: [{
			...
			files: { ".github": { "CODE_OF_CONDUCT.md": `# Contributor Covenant Code of Conduct
...
` } }
	...
	transition() {
		return { addons: [blockRemoveFiles({ files: ["CODE_OF_CONDUCT.md"] })] };
	}
});
//#endregion
export { blockContributorCovenant };
