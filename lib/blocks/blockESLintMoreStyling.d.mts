//#region src/blocks/blockESLintMoreStyling.d.ts
declare const stylisticComment = "Stylistic concerns that don't interfere with Prettier";
declare const blockESLintMoreStyling: import("bingo-stratum").BlockWithoutAddons<{
