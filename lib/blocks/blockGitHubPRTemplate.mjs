...
//#region src/blocks/blockGitHubPRTemplate.ts
const blockGitHubPRTemplate = base.createBlock({
	about: { name: "GitHub Issue Templates" },
	produce({ options }) {
		return { files: { ".github": { "PULL_REQUEST_TEMPLATE.md": `<!-- 👋 Hi, thanks for sending a PR to ${options.repository}! ${options.emoji}
