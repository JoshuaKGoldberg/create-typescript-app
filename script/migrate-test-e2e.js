...
await $({
	stdio: "inherit",
})`c8 -o ./coverage-migrate -r html -r lcov node ./bin/index.js  --description ${description} --mode migrate --owner ${owner} --title ${title} --repository ${repository} --skip-github-api --skip-contributors --skip-install`;
